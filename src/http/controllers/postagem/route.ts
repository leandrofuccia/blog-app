...
export async function postagemRoutes(app: FastifyInstance) {
  ...
  app.post('/posts', { schema: signinSchema }, create)
  ...
  app.put('/posts/:id', { schema: signinSchema }, update)
  ...
  app.get ('/posts/search/:termo', { schema: { querystring: requestQuerySchema } }, findPostagemBySearch)

  console.log('Registrando rota /posts')  
  app.get ('/posts', { schema: { querystring: requestQuerySchema } },findPostagem)
